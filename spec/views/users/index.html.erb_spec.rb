...
RSpec.describe "users/index.html.erb", type: :view do
  before do
    assign(:users, [
      User.create!(uuid: 123, name: {"last"=>"Kandasamy", "first"=>"ArunKumar", "title"=>"Mr"}, age: 30, gender: "Male", created_at: Time.zone.now),
      User.create!(uuid: 124, name: {"last"=>"ArunKumar", "first"=>"Megala", "title"=>"Mrs"}, age: 25, gender: "Female", created_at: Time.zone.now)
    ])
